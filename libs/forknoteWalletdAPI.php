<?php
 ...
 /
 / For ForkNote Coins: bikercoin Iridium bitcoal bytecoin crossnote
 /                     cryptopeg dashcoin dinastycoin ethanolium fosscoin
 /                     Iridiumwanec magnatoj quazarcoin redwind xcicoin iridium
 /
...
//      echo json_encode( $req );
      ...
      if( !isset($result['result']) ){ 
         ...
         if(isset($result['error'])) $e .= "Error(" . $result['error']['code'] . "): " . $result['error']['message'] . PHP_EOL;
         else $e .= "Unknown Error: " . print_r($result, true) . PHP_EOL;
